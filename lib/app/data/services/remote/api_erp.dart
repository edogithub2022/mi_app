...
//Recuperar total de OC agrupadas por empresas
  Future<GetOrdenCompracByEmpresasResult> getOCByEmpresa({
    ...
    try {
      ...
      final resul = await _http.request(
        '/api/v1/orden-compras/ocsbyempresa/',
        method: HttpMethod.get,
        headers: headers,
        queryParameters: query,
      );

      final OrdenCompraByEmpresaResponse ordenCompraByEmpresaResponse;

      //si no hay errores la peticion termino de forma exitosa
      if (resul.error == null) {
        //Token Valido
        ordenCompraByEmpresaResponse =
            OrdenCompraByEmpresaResponse.fromJson(resul.data);
        ocByEmpresa = ordenCompraByEmpresaResponse.data;
        return GetOcByEmpresasSuccess(ocByEmpresa);
      ...
      return GetOcByEmpresasFailure(failure);
    }
  }
